...
function handleLineMessage(event) {
  try {
    ...
    if (!employee.ok) {
      replyMessage(replyToken, ' 您尚未註冊為系統員工\n\n請先到網頁版登入以完成註冊\n https://eric693.github.io/Bryan_check_manager/');
      return;
    }
...
function sendLinePunchLink(replyToken, userId, employeeName, punchType) {
  ...
  const url = 'https://eric693.github.io/Bryan_check_manager/?linePunchToken=' + token;
        ...
        contents: [
          {
            ...
            action: {
              type: 'uri',
              label: '開啟網頁版',
              uri: 'https://eric693.github.io/Bryan_check_manager/'
            },
            color: '#FF9800'
          }
        ],
